...
var friends_list = new Vue({
    el: '#friends_list',
    data: {
        demo: [{Id: "5", Index: 5, Content: "haha", Logs:[{Id: "123453224", Date: "2017-8-8 5:45", Content: ""}, {Id: "123453224", Date: "2017-8-8 5:45", Content: ""}]},{Id: "2", Index: 2, Content: "haha"}]
    },
    computed: {
        datas() {
...
//     el: '.friends_list',
//     data: {
//         demo: [{Id: "5", Index: 5, Content: "haha"},{Id: "2", Index: 2, Content: "haha"}]
//     },
//     computed: {
//         datas() {
//             return this.demo.sort((a,b)=>a.Index-b.Index);
