...
<body>
    ...
    <div class="main">
        <div class="menu">
            ...
            <a href="/self/msg" class="listitem"></a>
            <!-- <a href="#" class="listitem"></a> -->
        ...
        <div class="content">
            <div class="seat"></div>
            <div class=""><input id="bt_add_friend" type="button" name="" value=""></div>

            <div class="newmessage"><button class="positive ui button" onclick="window.location.reload()"></button></div>
            ...
            <div class="items">
                ...
                <div id="item_<%$elem.Id%>" style="order:<%$elem.Order%>;" class="item">
                    ...
                    <div class="content">
                        ...
                        <input type="button" name="" onclick="openMsgDialog(<%$i%>)" value="">
                    </div>
                </div>
                <% end %>
            </div>
    ...
    <div id="dialog_addfriend" class="dialog">
        <div>
            ID:<input id="input_id" type="text" name="">
        </div>
        <div>
            <input id="bt_cancel" type="button" name="" value=""><input id="bt_add" type="button" name="" value="">
        </div>
    </div>
    ...
    <div id="dialog_msg_<% $i %>" class="dialog_msg">
        <div class="msgcontent">
            <div class="">
                <div class="msgrecv"></div>
            </div>
            <div class="">
                <div class="msgsend"></div>
            </div>
        </div>
        <div class="msgfloor">
            <input type="button" name="" onclick="closeMsgDialog(<%$i%>)" value=""><input id="bt_add" type="button" name="" value="">
        </div>
    </div>
    <% end %>
